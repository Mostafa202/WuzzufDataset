...
public class main {
    ...
    public static List<String>company_jobs;
    public static List<String>areas;
    public static List<String>job_titles;
    public static List<String>job_skills;

    public static void main(String[] args) throws IOException {

        // display the dataset
        String Path="/home/mostafa/Documents/dataset/Wuzzuf_Jobs.csv";
        DAO data=new DAO();
        ...
        company_jobs=col_company_list;
        job_titles=processed_title;
        areas=col_location_list;
        job_skills=processed_skill;
     ...
     double value = evaluator.evaluate(predictions);
     System.out.println("value with squared euclidean distance = " + value);
