...
public class DAO {
    ...
    //counting skills
    public Map<String,Long> counting_skills(List<String> jobs)
   ...
   oldValue,LinkedHashMap::new));
    ...
    //counting areas
    public Map<String,Long> counting_areas(List<String> areas)
    {
    	Map<String, Long> result =
    ...
    //counting job titles
    public Map<String,Long> counting_job_titles(List<String> titles) {
    	Map<String, Long> result =
    ...
    public LinkedHashMap<String, Long> count_jobs(List<String> jobs) {
